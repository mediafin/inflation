...
## 3 Rescale HBS-weights by income group
...
## 5 Reproduce inflation based on rescaled and updated coicop3 weights
...
#reproduce inflation
df_inflation_hbs_wt <- df_merged_cpi_hbs %>% 
